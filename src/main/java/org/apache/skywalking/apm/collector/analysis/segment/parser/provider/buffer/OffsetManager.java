...
public enum OffsetManager {
    ...
    static {
        logger.info("==========> OffsetManager patch 1970");
    }
    ...
    public synchronized void initialize() throws IOException {
        if (!initialized) {
            ...
            Executors.newSingleThreadScheduledExecutor().scheduleAtFixedRate(new RunnableWithExceptionProtection(this::flush, t -> logger.error("flush offset file in background failure.", t)), 10, 3, TimeUnit.SECONDS);
        }
    }
